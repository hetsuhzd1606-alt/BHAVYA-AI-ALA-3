...
def chatbot_reply(message):
    ...
    # --- Math ---
        ...
        try:
            ...
            return "⚠ Please enter a valid math expression, e.g., 2+2 or 3*5."
    ...
    if "cpu" in msg:
        return "🖥 CPU is the brain of your computer."
    if "ram" in msg:
        return "💾 RAM stores temporary data for running programs."
    if "database" in msg:
        return "🗄 Databases store and manage information efficiently."
    if "network" in msg:
    ...
    if "grammar" in msg or "english" in msg:
        return "✏ I can explain English grammar basics like nouns, verbs, and adjectives."
